                         ...
                         bool iqInverted, bool rxContinuous )
{
    ...
    switch( modem )
    {
        case MODEM_FSK:
            ...
            // SX126x.ModulationParams.Params.Gfsk.ModulationShaping = MOD_SHAPING_OFF;
            ...
            // SX126x.PacketParams.Params.Gfsk.PreambleMinDetect = RADIO_PREAMBLE_DETECTOR_OFF;//RADIO_PREAMBLE_DETECTOR_32_BITS
            SX126x.PacketParams.Params.Gfsk.PreambleMinDetect = RADIO_PREAMBLE_DETECTOR_08_BITS;//RADIO_PREAMBLE_DETECTOR_32_BITS
            // SX126x.PacketParams.Params.Gfsk.PreambleMinDetect = RADIO_PREAMBLE_DETECTOR_32_BITS;//
            ...
            if( crcOn == true )
            {
                // SX126x.PacketParams.Params.Gfsk.CrcLength = RADIO_CRC_2_BYTES_CCIT;//RADIO_CRC_2_BYTES_IBM
            ...
            // SX126xSetSyncWord( ( uint8_t[] ){ 0x2D, 0xD4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } );
...
void RadioIrqProcess( void )
{
    if( IrqFired == true )
    {
        ...
        if( ( irqRegs & IRQ_RX_DONE ) == IRQ_RX_DONE )
        {
            ...
            {
								//Return RSSI information for FSK or LoRa
								if( RadioPktStatus.packetType == PACKET_TYPE_GFSK )
